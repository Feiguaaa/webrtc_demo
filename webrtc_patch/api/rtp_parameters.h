...
struct RTC_EXPORT RtpExtension {
  ...
  // Header extension for encoder target bitrate (uint16 kbps, big-endian).
  static constexpr char kEncoderTargetBitrateUri[] =
      "http://www.webrtc.org/experiments/rtp-hdrext/encoder-target-bitrate";

  // Header extension for frame packet info (total_packets, packet_index).
  static constexpr char kFramePacketInfoUri[] =
      "http://www.webrtc.org/experiments/rtp-hdrext/frame-packet-info";
